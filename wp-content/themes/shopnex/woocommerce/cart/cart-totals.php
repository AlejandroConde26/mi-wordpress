...
<div class="cart_totals <?php echo esc_attr( WC()->customer->has_calculated_shipping() ? 'calculated_shipping' : '' ); ?>">
	...
	<h2><?php esc_html_e( 'Order Summary', 'shopnex' ); ?></h2>

	<div class="shop_table woocommerce-cart-totals">
		...
		<table cellspacing="0" class="shop_table shop_table_responsive">
			<tbody>
				<tr class="cart-subtotal">
					...
					<td data-title="<?php esc_attr_e( 'Subtotal', 'shopnex' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></td>
				</tr>
				...
				<?php elseif ( WC()->cart->needs_shipping() && 'yes' === get_option( 'woocommerce_enable_shipping_calc' ) ) : ?>
					...
					<tr class="shipping">
						<th><?php esc_html_e( 'Shipping', 'shopnex' ); ?></th>
						<td data-title="<?php esc_attr_e( 'Shipping', 'shopnex' ); ?>"><?php woocommerce_shipping_calculator(); ?></td>
					</tr>
				...
				if ( wc_tax_enabled() && ! WC()->cart->display_prices_including_tax() ) {
					...
					if ( WC()->customer->is_customer_outside_base() && ! WC()->customer->has_calculated_shipping() ) {
						$estimated_text = sprintf(
							' <small>' . esc_html__( '(estimated for %s)', 'shopnex' ) . '</small>',
				...
				<tr class="order-total">
					...
					<td data-title="<?php esc_attr_e( 'Total', 'shopnex' ); ?>"><?php wc_cart_totals_order_total_html(); ?></td>
				</tr>
