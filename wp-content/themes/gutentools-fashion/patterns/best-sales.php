...
/**
 * Title: Best Sales
 * Slug: gutentools-fashion/best-sales
 ...
 */
?>
<!-- wp:group {"metadata":{"name":"Best Sales"},"style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|20","right":"var:preset|spacing|20"}}},"layout":{"type":"constrained"}} -->
...
<p class="has-text-align-center" style="text-transform:uppercase"><?php echo esc_html__( 'Best Deals', 'gutentools-fashion' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"style":{"spacing":{"margin":{"top":"0","bottom":"0"}},"typography":{"textAlign":"center"}}} -->
<h2 class="wp-block-heading has-text-align-center" style="margin-top:0;margin-bottom:0"><?php echo esc_html__( 'Offers On Trending Fashion', 'gutentools-fashion' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
